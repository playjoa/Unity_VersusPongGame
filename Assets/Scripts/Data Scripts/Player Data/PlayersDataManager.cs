...
public static class PlayersDataManager
{
    ...
    public static int CurrentLevelIDToPlay()
    {
        RequestLoadDataIfNotSet();
        return allPlayersData.currentLevelToPlay;
    }

    public static void SetNewLevelIDToPlay(int newValueToSet)
    {
        RequestLoadDataIfNotSet();
        allPlayersData.currentLevelToPlay = newValueToSet;
        DataStorer.SaveData(allPlayersData);
    }
