...
public class InitialLoader : MonoBehaviour
{
    ...
    private void Awake()
    {
        DisableLoggingIfOnBuild();
    }

    void DisableLoggingIfOnBuild() 
    {
        #if UNITY_EDITOR
    ...
    string TransformFloatToStringPercentage(float progress) => (progress * 100f).ToString("F2") + "% ";
    ...
    IEnumerator LoadScene()
    {
        ...
        while (!opperation.isDone)
        {
            ...
            txtPorcent.text = TransformFloatToStringPercentage(progress);
